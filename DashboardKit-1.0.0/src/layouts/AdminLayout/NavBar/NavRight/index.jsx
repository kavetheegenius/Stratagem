          ...
          <Dropdown.Menu className="dropdown-menu-end pc-h-dropdown drp-search">
            <Form className="px-3">
              <div className="form-group mb-0 d-flex align-items-center">
                ...
                <Form.Control type="search" className="border-0 shadow-none" placeholder="Search markets, symbols..." />
              </div>
            </Form>
          </Dropdown.Menu>
        </Dropdown>
      ...
      <ListGroup.Item as="li" bsPrefix=" " className="pc-h-item">
        <Dropdown className="drp-user">
          <Dropdown.Toggle as="a" variant="link" className="pc-head-link arrow-none me-0 user-name">
            ...
            <span>
              <span className="user-name">Trader Account</span>
              <span className="user-desc">Active Trader</span>
            </span>
          </Dropdown.Toggle>
          <Dropdown.Menu className="dropdown-menu-end pc-h-dropdown">
            <Dropdown.Header className="pro-head">
              <h5 className="text-overflow m-0">
                <span className="badge bg-light-success">Pro Trader</span>
              </h5>
            </Dropdown.Header>
